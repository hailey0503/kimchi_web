  ...
  const fetchTransactions = (sortingOption) => {
    axios
      ...
      .then((response) => {
        ...
        const transactions = response.data["mbx"];
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <h1 className={styles.title}>Marblex Transaction Finder</h1>
        ...
        <div className={styles.inputContainer}>
            ...
            >
              ...
              <option value="sender">지갑주소r</option>
            </select>
            <input
              type="text"
        ...
        <div className={styles.filterSortSection}>
          <div className={styles.sortSection}>
            ...
            >
              ...
              <option value="timestamp_desc">최근거래</option>
              <option value="amount_desc">거래크기 (High to Low)</option>
              <option value="amount_asc">거래크기 (Low to High)</option>
            </select>
          </div>
        </div>
